# Beatriz Neves, 17 de janeiro 2025
# Input = Pasta Final TFRecord - Material + Ano + Estrutura (Treino, Teste e Validação)
...
base_model = tf.keras.models.load_model('Tentativa 1 - Material + Estrutura (Do Zero).h5')
...
model.save('Tentativa 1 - Material + Ano + Estrutura (Com Tentativa 1 - Material + Estrutura (Do Zero)).h5')
...
plot_roc_for_eleven_classes(range(11), '../Com Tentativa 1 - Material + Ano (Do Zero)/ROC.png')
