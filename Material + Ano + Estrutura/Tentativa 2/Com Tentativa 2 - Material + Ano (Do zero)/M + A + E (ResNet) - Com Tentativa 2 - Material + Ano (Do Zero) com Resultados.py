...
# --------------------- Modelo ------------------
model = tf.keras.models.load_model('Tentativa 2 - Material + Ano (Do zero).h5')
...
model.save('Tentativa 2 - Material + Ano + Estrutura (Com Tentativa 2 - Material + Ano (Do zero)).h5')
