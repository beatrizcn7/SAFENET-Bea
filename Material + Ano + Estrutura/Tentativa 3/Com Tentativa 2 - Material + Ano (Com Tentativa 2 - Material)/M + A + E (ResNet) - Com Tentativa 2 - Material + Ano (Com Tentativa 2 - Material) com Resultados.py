...
from sklearn.preprocessing import label_binarize # Transforma um array de classes numa matriz binári

# --------------------- Modelo ------------------
model = tf.keras.models.load_model('Tentativa 2 - Material + Ano (Com Tentativa 2 - Material).h5')
...
model.save('Tentativa 2 - Material + Ano + Estrutura (Com Tentativa 2 - Material + Ano (Com Tentativa 2 - Material)).h5')
