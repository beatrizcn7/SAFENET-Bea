...
df_combinacoes = df_base[['TEC - Tipo de Estrutura', 'Intervalo de Anos', 'CON - Material 1', 'Fotos']].dropna()
...
tipos_estrutura = [
    'Alvenaria Alargada', 'Arco (simples ou múltiplos)', 'Arco Pré-Fabricado', 'Estrutura Tubular tipo "ARMCO"',
    'Misto de Soluções', 'Outro', 'Pórtico', 'Quadro', 'Tabuleiro simples/apoiado', 'Tirantes', 'Vãos Multiplos', 'Vigas Gerber'
]
materiais = [
    'Aço', 'Aço (tipo ARMCO)', 'Aço aparafusado', 'Aço rebitado', 'Alvenaria de Pedra', 'Alvenaria de Tijolo',
    'Alvenaria Rebocada', 'Betão Armado', 'Betão Armado Pré-esforçado', 'Ferro', 'Misto Aço-Betão', 'Outros'
]
...
output_excel_path = 'Combinações Completas Excel.xlsx'
