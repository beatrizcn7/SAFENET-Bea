# Beatriz Neves, 15 de janeiro de 2025
# Input = Pasta Final TFRecord - Material + Estrutura (Treino, Teste e Validação)
...
# Criar uma camada densa com 6 classes (saída da classificação) e função de ativação softmax
...
plot_roc_for_three_classes(range(6), 'ROC.png')
