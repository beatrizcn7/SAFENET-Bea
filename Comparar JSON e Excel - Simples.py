...
arquivo_combinacoes_json = 'Combinações JSON.xlsx'
arquivo_combinacoes_excel = 'Combinações Excel.xlsx'
...
df_combinacoes_json = df_combinacoes_json[['Tipo de Estrutura', 'Intervalo de Anos', 'Material', 'Qtd']]
df_combinacoes_excel = df_combinacoes_excel[['Tipo de Estrutura', 'Intervalo de Anos', 'Material', 'Qtd']]
...
output_excel_path = 'Comparação Simples (JSON vs. Excel).xlsx'
