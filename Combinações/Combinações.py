# Beatriz Neves, 9 de setembro de 2024
# Input = Pasta JSON (mudar depende de onde quiser contar as combinações)
# Output = Excel com a quantidade de cada combinação
# Objetivo = Contar as combinações possíveis das 3 propriedades
...
output_excel_path = 'Segunda fase.xlsx'
