...
arquivo_combinacoes_json = 'Combinações Completas JSON 2.xlsx'
arquivo_combinacoes_excel = 'Combinações Completas Excel 2.xlsx'
...
output_excel_path = 'Comparação Completas (JSON vs. Excel) 2.xlsx'
