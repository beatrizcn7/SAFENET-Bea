...
# Objetivo = Treinar um modelo ResNet50 com a informação input, mesmo que o script Tentativa 2, mas sem os ficheiros de output
...
# Guardarr o dataframe num ficheiro Excel
...
# Guardar o dataframe das métricas num ficheiro Excel
