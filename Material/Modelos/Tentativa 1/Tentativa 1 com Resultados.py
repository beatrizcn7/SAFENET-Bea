...
# Função para fazer o gráfico de ROC para as 3 classes
def plot_roc_for_three_classes(classes, file_name):
    plt.figure(figsize=(15, 5))  # Ajuste para 3 colunas e 1 linha
...
plot_roc_for_three_classes(range(3), 'Material/Modelos/Tentativa 1/ROC.png')
