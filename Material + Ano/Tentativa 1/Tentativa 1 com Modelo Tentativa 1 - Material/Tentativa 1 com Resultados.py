...
model = tf.keras.models.load_model('Modelos/Tentativa 1 - Material.h5')

model.pop()  # Remover a última camada de saída (3 classes)
...
model.save('Tentativa 1 - Material + Ano (aprendido com Tentativa 1 - Material).h5')
