...
# model.save('Tentativa 2 - Material.h5')
...
results_df.to_excel('Ao longo das Épocas 1.xlsx', index=False)
...
plt.tight_layout()
plt.savefig('Loss e Accuracy 1.png')  # Guardar os gráficos numa imagem
plt.show()
...
metrics_df.to_excel('Métricas 1.xlsx', index=False)

print('Métricas calculadas')

metrics = ['Accuracy', 'Precision', 'Recall', 'F1 Score']
file_names = ['Accuracy 1.png', 'Precision 1.png', 'Recall 1.png', 'F1 Score 1.png']
...
plt.savefig('Matriz de Confusão 1.png')  # Guardar a matriz de confusão como imagem
plt.show()
...
cm_df.to_excel('Matriz de Confusão 1.xlsx', index=True)
...
plot_roc_for_three_classes(range(3), 'ROC 1.png')
