...
heading_start = (math.degrees(math.atan2(delta_y_start, delta_x_start))) % 360
heading_start = (heading_start + 25) % 360
...
heading_end = (math.degrees(math.atan2(delta_y_end, delta_x_end))) % 360
heading_end = (heading_end + 40) % 360
...
file_path_start = "p_start.jpg"
file_path_end = "p_end.jpg"
